 ...
 * <a href="https://en.wikipedia.org/wiki/Barnsley_fern">Barnsley's fern</a>
 * using the {@link ChaosGame}.
 * 
...
public class BarnsleysFern {
	...
	public static void main(String[] arguments) throws IOException {
		...
		int[][] histogram = ff.chaosGame(10000, 5000,
				new Rectangle2D.Double(-5.5, -1.0, 12.0, 12.0), new Dimension(1000, 1000));
